...
class Medicine(models.Model):
    ...
    active_ingredients = models.CharField(max_length=500, blank=True, help_text="المواد الفعالة")
    concentration = models.CharField(max_length=200, blank=True, help_text="التركيزات")
    alternatives = models.TextField(blank=True, help_text="البدائل والأدوية المتشابهة")
    region_availability = models.CharField(max_length=200, blank=True, help_text="مناطق التوافر")
    manufacturer = models.CharField(max_length=200, blank=True)
    packaging = models.CharField(max_length=200, blank=True, help_text="التعبئة/الشكل الدوائي")
